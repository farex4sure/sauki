...
<body class="bg-[#e0e0e0] font-raleway">
  <div>
    <div class="h-44 bg-primary rounded-b-[30%] px-7">
          ...
          <a href="./appointment.php">
            <svg width="30" height="30" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clip-path="url(#clip0_16_128)">
                <rect x="-23.7188" y="-35.2188" width="92" height="92" fill="white" />
                <path
                  d="M29.536 30.8392L20.7577 22.0417L29.536 13.2442L26.8335 10.5417L15.3335 22.0417L26.8335 33.5417L29.536 30.8392Z"
                  fill="#189BCC" />
              </g>
              <defs>
      ...
      <p class="text-center font-bold text-xl text-white mt-7">Appointment History</p>
    </div>
