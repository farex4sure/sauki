  ...
  <div>
    ...
    <div class="my-5 mx-5 relative pb-12">
      ...
      <div class="mb-10">
        ...
        <form id="aform" method="POST" class="space-y-5">
          <div>
            <label for="date" class="font-semibold">Date</label>
            <input type="date" name="app-date" class="input">
            <input type="text" class="hidden" name="hcode" value="<?php echo $hcode ?>" class="input">
            <input type="text" class="hidden" name="phone" value="<?php echo $phoneid ?>" class="input">
          </div>
        
      </div>
       <button type="submit" class="block text-white bg-cyan-600 hover:bg-cyan-600 focus:ring-4  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center focus:outline-none focus:ring-primary font-medium rounded-lg text-sm px-5 py-2.5 text-center " type="button" data-modal-toggle="popup-modal">
  Book Appointment 
</button>
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Congratulation!!! You have successfully booked an appointment, Your Number is <div id="resp"></div>  </h3>
                <a href="dashboard.php" data-modal-toggle="popup-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Back</a>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function () {
  ...
  $("#aform").submit(function(e) {
    ...
    $("#resp").html("<div class='bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3' role='alert'><p class='font-bold'>Book Added</p><p class='text-sm'>You have added a new book</p></div>");
