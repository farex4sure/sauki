  ...
  <div>
    ...
    <div class="my-5 mx-5 relative pb-12">
      ...
      <div class="mb-10 space-y-5">
        <div class="text-primary bg-white rounded-lg py-3 px-4">
          <p class="font-semibold text-3xl">HMP's</p>
        </div>
        <div class="bg-white text-primary rounded-lg py-3 px-4">
          <p class="font-semibold text-3xl">PPO's </p>
        </div>
        <div class="bg-white text-primary rounded-lg py-3 px-4">
          <p class="font-semibold text-3xl">NHIS</p>
        </div>
      </div>
